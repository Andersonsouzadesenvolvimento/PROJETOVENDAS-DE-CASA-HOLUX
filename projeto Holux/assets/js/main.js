...
const scrollActive = () => {
  ...
  sections.forEach((current) => {
    const sectionHeight =
        current.offsetHeight /*const recebe a altura da section */,
      sectionTop =
        current.offsetTop -
        58 /* const recebe a posição superior (em pixels) em relação ao pai*/,
      sectionId =
        current.getAttribute('id') /*const recebe o id da posição current*/,
